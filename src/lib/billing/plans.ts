...
function p(id: Plan, label: string, monthly: number, seats: number, blurb: string): PlanPricing {
  return { id, label, monthlyCents: monthly, annualCents: monthly * ANNUAL_MONTHS_CHARGED, seats, blurb }
}
...
export const PLAN_PRICING: PlanPricing[] = [
  ...
  p('CFO', 'CFO Suite', 79_900, Number.POSITIVE_INFINITY, 'Multi-entity, white-label, and a client portal for fractional CFOs.'),
]
